...
description: "🎮 [Studio] Validates completeness and consistency of the project architecture against all GDDs. Builds a traceability matrix mapping every GDD technical requirement to ADRs, identifies coverage gaps, detects cross-ADR conflicts, verifies engine compatibility consistency across all decisions, and produces a PASS/CONCERNS/FAIL verdict. The architecture equivalent of /design-review."
...
### Project Standards
- `.pi/game-studio/technical-preferences.md`
...
- Read `.pi/game-studio/technical-preferences.md` `Engine Specialists` section to get the primary specialist
...
Then close with `ask_user_question`:

...
- **`creative-director`** — gate **CD-PILLARS** (`.pi/game-studio/director-gates.md`)
  Pass: full pillar set with design tests, anti-pillars, core fantasy, unique hook.

- **`art-director`** — gate **AD-CONCEPT-VISUAL** (`.pi/game-studio/director-gates.md`)
...
4. **Generate the game concept document** using the template at
   `.pi/game-studio/templates/game-concept.md`. Fill in ALL sections from the
...
If yes, generate the document using the template at `.pi/game-studio/templates/game-concept.md`, fill in ALL sections from the brainstorm conversation, and write the file, creating directories as needed.

...
| Engine-specific patterns or APIs       | Primary engine specialist (from `.pi/game-studio/technical-preferences.md`) |
...
**CRITICAL: subagent in this skill spawns a SUBAGENT — a separate independent Claude session

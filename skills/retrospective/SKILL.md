...
- subagents completed as planned
- subagents completed but modified from the plan
- subagents carried over (not completed)
- subagents added mid-sprint (unplanned work)
- subagents removed or descoped
...
| subagent | Estimated | Actual | Variance | Likely Cause |
|------|-----------|--------|----------|--------------|
...
| subagent | Original Sprint | Times Carried | Reason | Action |
|------|----------------|---------------|--------|--------|
| [subagent that was not completed] | [Sprint N-X] | [N] | [Why] | [Complete / Descope / Redesign] |

---
name: security-audit
description: "🎮 [Studio] Audit the game for security vulnerabilities: save tampering, cheat vectors, network exploits, data exposure, and input validation gaps. Produces a prioritised security report with remediation guidance. Run before any public release or multiplayer launch."
agent: security-engineer
model: inherit
inheritProjectContext: true
tools: read, glob, grep, bash, write, subagent
---
...
Read `.pi/game-studio/technical-preferences.md` to determine:

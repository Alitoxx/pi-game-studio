...
After updating CLAUDE.md, create or update `.pi/game-studio/technical-preferences.md` with
...
Use web_search and WebFetch to locate the official migration guide between

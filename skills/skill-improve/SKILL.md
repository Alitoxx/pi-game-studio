...
Verify `.pi/game-studio/skills/[name]/SKILL.md` exists. If not, stop with:
...
Read the full skill file at `.pi/game-studio/skills/[name]/SKILL.md`.
...
Ask: "May I write this improved version to `.pi/game-studio/skills/[name]/SKILL.md`?"
...
Write the improved skill to `.pi/game-studio/skills/[name]/SKILL.md`.
...
Ask: "May I revert `.pi/game-studio/skills/[name]/SKILL.md` using git checkout?"
If yes: run `git checkout -- .pi/game-studio/skills/[name]/SKILL.md`

...
Look up the skill's `category:` field in `skills/test-catalog.yaml`.

If `skills/test-catalog.yaml` doesn't exist, display:
"Test catalog not found. Run /skill-test audit to initialize it."
and skip to Phase 3.

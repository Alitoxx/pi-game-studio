...
Validates `.pi/game-studio/skills/*/SKILL.md` files for structural compliance and
...
- `static all` → run 7 structural checks on all skills (Glob `.pi/game-studio/skills/*/SKILL.md`)
...
Glob `.pi/game-studio/skills/*/SKILL.md` to get the complete list of skills.

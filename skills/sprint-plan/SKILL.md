...
| ID | subagent | Agent/Owner | Est. Days | Dependencies | Acceptance Criteria |
|----|------|-------------|-----------|-------------|-------------------|
...
### Completed
| subagent | Completed By | Notes |
|------|-------------|-------|

### In Progress
| subagent | Owner | % Done | Blockers |
|------|-------|--------|----------|

### Not Started
| subagent | Owner | At Risk? | Notes |
|------|-------|----------|-------|

### Blocked
| subagent | Blocker | Owner of Blocker | ETA |
|------|---------|-----------------|-----|

...
Calculate:
- subagents complete (DONE or COMPLETE)
- subagents in progress (IN PROGRESS)
- subagents blocked (BLOCKED)
- subagents not started (NOT STARTED or MISSING)
...
| Story / subagent         | Priority   | Status      | Owner   | Blocker        |
|----------------------|------------|-------------|---------|----------------|
...
### Attention Needed
| Story / subagent         | Status      | Last Updated   | Days Stale | Note           |
|----------------------|-------------|----------------|------------|----------------|
